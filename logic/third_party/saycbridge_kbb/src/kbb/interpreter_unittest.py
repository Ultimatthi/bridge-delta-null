...
class BidInterpreterTest(unittest2.TestCase):
    ...
    def test_negative_double(self):
        ...
        self.assertEqual(hand_knowledge.min_length(HEARTS), 4)
        self.assertEqual(hand_knowledge.min_length(SPADES), 4)
        hand_knowledge = self._hand_knowledge_from_last_call("1D 1H X")
        self.assertEqual(hand_knowledge.min_length(SPADES), 4)
        self.assertEqual(hand_knowledge.max_length(SPADES), 4)
